...
class WaterPurifierPage extends StatelessWidget {
  const WaterPurifierPage({Key? key}) : super(key: key);
  ...
  List<Widget> _getServiceOptions(BuildContext context) {
    final List<Map<String, dynamic>> services = [
      ...
      },
      {
        ...
        'note': 'Sir/Madam, final bill technician product check karne ke baad generate karega, jo market ke hisaab se reasonable rate hoga.',
      },
    ];
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (service['note'] != null && service['priceType'] != 'inspection') ...[
